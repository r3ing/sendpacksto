        ...
        <div class="row">
            ...
            <div class="container text-center">
                <div class="section-title">
                    <h2 class="title"><i class="fa fa-product-hunt"></i> Editar Producto</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    <div class="page">
                        {!! Form::model($product, ['method' => 'PUT', 'action' => ['Admin\ProductController@update', $product->identifier], 'files' => true]) !!}
