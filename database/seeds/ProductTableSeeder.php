    ...
    public function run()
    {
		$data = array(
			[
				...
				'price' 		=> 99.95,
				'weight' 		=> 10,
				'image'        => '1_Samsung_Note9_black_DN.png',
				'visible' 		=> 1,
